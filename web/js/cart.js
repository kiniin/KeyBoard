$(function () {
    ...
    $(".num .add").click(function () {
        ...
        var productNum = parseInt($(this).siblings("span").text());
        ...
        if (productNum >= 5) {
            ...
            productNum++;
            $(this).siblings("span").text(productNum);
            $(this).siblings("span").children("input").attr("value",productNum);

            $(this).parent().parent().siblings(".sAll").text("$"+(productNum*price).toFixed(2));
            var proID = $(this).parents(".cart").attr("id");

            var xmlhttp = new XMLHttpRequest();
            var url = "./changeCart?proID="+proID+"&updown=1";
